...
@OnlyIn(Dist.CLIENT)
public class EnderKidModel<T extends EnderKidEntity> extends AbstractZombieModel<T>
{
	   public EnderKidModel(float p_i1168_1_, boolean p_i1168_2_) {
		      this(p_i1168_1_, 0.0F, 64, p_i1168_2_ ? 32 : 64);
		   }

		   public EnderKidModel(float p_i48914_1_, float p_i48914_2_, int p_i48914_3_, int p_i48914_4_) {
