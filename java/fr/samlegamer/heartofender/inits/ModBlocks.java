...
public class ModBlocks
{
    ...
    public static final RegistryObject<Block> DEAD_SAND = createBlock("dead_sand", () -> new SandDeadBlock(Material.SAND, 2, 1, 3, SoundType.SOUL_SAND));
    ...
    public static final RegistryObject<Block> PURPLE_GLOWSTONE = createBlock("purple_glowstone", () -> new GlowstonePurpleBlock(Material.GLASS, 3, 10, SoundType.GLASS));
