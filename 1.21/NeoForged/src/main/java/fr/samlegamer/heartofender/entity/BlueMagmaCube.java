...
public class BlueMagmaCube extends Slime
{
	...
	public BlueMagmaCube(EntityType typeentity, Level world)
	   {
		   super(typeentity, world);
		      this.xpReward = 8;
	   }
	   
	   public BlueMagmaCube(PlayMessages.SpawnEntity spawnEntity, Level worldIn)
	    {
	        this(HoeEntityRegistry.BLUE_MAGMA_CUBE, worldIn);
	    }
