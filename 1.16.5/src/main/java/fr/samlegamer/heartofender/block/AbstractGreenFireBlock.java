...
public abstract class AbstractGreenFireBlock extends Block
{
	   ...
	   public AbstractGreenFireBlock(AbstractBlock.Properties p_i241173_1_, float p_i241173_2_)
	   {
	      super(p_i241173_1_);
	   ...
	   {
		   return p_235577_0_.is(ModBlocks.DARK_END_STONE.get());
	   }
	   ...
	   public abstract boolean canBurn(BlockState p_196446_1_);
	...
	public void entityInside(BlockState p_196262_1_, World p_196262_2_, BlockPos p_196262_3_, Entity p_196262_4_) {
	   ...
	   protected static boolean inPortalDimension(World p_242649_0_)
	   {
	      return p_242649_0_.dimension() == World.OVERWORLD || p_242649_0_.dimension() == ModDimension.HEART_OF_ENDER;
	   }
