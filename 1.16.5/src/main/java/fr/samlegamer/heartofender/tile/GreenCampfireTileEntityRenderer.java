...
@OnlyIn(Dist.CLIENT)
public class GreenCampfireTileEntityRenderer extends TileEntityRenderer<GreenCampfireTileEntity>
{
	   public GreenCampfireTileEntityRenderer(TileEntityRendererDispatcher p_i226007_1_)
	   {
		   super(p_i226007_1_);
	   }

		   public void render(GreenCampfireTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
		      Direction direction = p_225616_1_.getBlockState().getValue(GreenCampfireBlock.FACING);
