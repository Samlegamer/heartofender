...
public class HeartSkeletonEntity extends AbstractSkeletonEntity
{
	   @SuppressWarnings({ "rawtypes" })
	   public HeartSkeletonEntity(EntityType typeentity, World world)
	   {
		   super(typeentity, world);
		      this.xpReward = HoeConfig.HeartSkeletonExp;
		   this.setPathfindingMalus(PathNodeType.LAVA, 8.0F);
	   }

	   public HeartSkeletonEntity(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn)
	    {
	        this(ModEntities.HEART_SKELETON, worldIn);
	    }

	   public static AttributeModifierMap.MutableAttribute createAttributes()
	   {
		   return MonsterEntity.createMonsterAttributes()
				   .add(Attributes.MAX_HEALTH, HoeConfig.HeartSkeletonMaxHealth)
				   .add(Attributes.ARMOR, HoeConfig.HeartSkeletonArmor)
				   .add(Attributes.ATTACK_DAMAGE, HoeConfig.HeartSkeletonAttackDamage)
				   .add(Attributes.MOVEMENT_SPEED, HoeConfig.HeartSkeletonMovementSpeed)
		   ...
		   {
		      this.setItemSlot(EquipmentSlotType.MAINHAND, new ItemStack(ModItems.AZURIUM_AXE.get()));
		   }
