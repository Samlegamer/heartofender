...
public class HeartGhastEntity extends FlyingEntity implements IMob
{
	   private static final DataParameter<Boolean> DATA_IS_CHARGING = EntityDataManager.defineId(HeartGhastEntity.class, DataSerializers.BOOLEAN);
	   private int explosionPower = 3;

	   @SuppressWarnings({ "rawtypes"})
	   public HeartGhastEntity(EntityType typeentity, World p_i50206_2_) {
	      super(typeentity, p_i50206_2_);
	      this.xpReward = HoeConfig.HeartGhastExp;
	      this.moveControl = new HeartGhastEntity.MoveHelperController(this);
	   }
	   
	    public HeartGhastEntity(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn)
	    {
	        this(ModEntities.HEART_GHAST, worldIn);
	    }

	   protected void registerGoals() {
	      this.goalSelector.addGoal(5, new HeartGhastEntity.RandomFlyGoal(this));
	      this.goalSelector.addGoal(7, new HeartGhastEntity.LookAroundGoal(this));
	      this.goalSelector.addGoal(7, new HeartGhastEntity.FireballAttackGoal(this));
	   ...
	   public static AttributeModifierMap.MutableAttribute createAttributes() {
	      return MobEntity.createMobAttributes()
	    		  .add(Attributes.MAX_HEALTH, HoeConfig.HeartGhastMaxHealth)
	   ...
	   public static boolean checkGhastSpawnRules(EntityType<HeartGhastEntity> p_223368_0_, IWorld p_223368_1_, SpawnReason p_223368_2_, BlockPos p_223368_3_, Random p_223368_4_) {
	   ...
	   static class FireballAttackGoal extends Goal {
	      ...
	      public FireballAttackGoal(HeartGhastEntity p_i45837_1_) {
	   ...
	   static class LookAroundGoal extends Goal {
	      ...
	      public LookAroundGoal(HeartGhastEntity p_i45839_1_) {
	   ...
	   static class MoveHelperController extends MovementController {
	      ...
	      public MoveHelperController(HeartGhastEntity p_i45838_1_) {
	         super(p_i45838_1_);
	   ...
	   static class RandomFlyGoal extends Goal {
	      ...
	      public RandomFlyGoal(HeartGhastEntity p_i45836_1_) {
