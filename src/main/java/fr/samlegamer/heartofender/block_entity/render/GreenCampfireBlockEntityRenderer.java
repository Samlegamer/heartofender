...
@OnlyIn(Dist.CLIENT)
public class GreenCampfireBlockEntityRenderer extends CampfireRenderer
{
	public GreenCampfireBlockEntityRenderer(Context p_173602_)
	{
		super(p_173602_);
	}

	public void render(GreenCampfireBlockEntity p_112344_, float p_112345_, PoseStack p_112346_, MultiBufferSource p_112347_, int p_112348_, int p_112349_) {
	      Direction direction = p_112344_.getBlockState().getValue(GreenCampfire.FACING);
