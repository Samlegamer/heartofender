...
public class HoeBlockEntityRegistry
{
	...
	public static final RegistryObject<BlockEntityType<GreenCampfireBlockEntity>> GREEN_CAMPFIRE_TILE = REGISTRY_BLOCK_ENTITY.register("green_campfire", () -> BlockEntityType.Builder.of(GreenCampfireBlockEntity::new, HoeBlocksRegistry.GREEN_CAMPFIRE.get()).build(null));
}