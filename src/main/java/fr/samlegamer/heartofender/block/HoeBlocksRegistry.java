...
public class HoeBlocksRegistry
{
    ...
    //For new version
    public static final RegistryObject<Block> LILAC_STEM = createBlock("lilac_stem", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(2.0F).sound(SoundType.STEM)));
    public static final RegistryObject<Block> LEAFY_STEM = createBlock("leafy_stem", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(2.0F).sound(SoundType.STEM)));
    public static final RegistryObject<Block> STRIPPED_LILAC_STEM = createBlock("stripped_lilac_stem", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> STRIPPED_LEAFY_STEM = createBlock("stripped_leafy_stem", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LILAC_HYPHAE = createBlock("lilac_hyphae", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(2.0F).sound(SoundType.STEM)));
    public static final RegistryObject<Block> LEAFY_HYPHAE = createBlock("leafy_hyphae", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(2.0F).sound(SoundType.STEM)));
    public static final RegistryObject<Block> STRIPPED_LILAC_HYPHAE = createBlock("stripped_lilac_hyphae", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(2.0F).sound(SoundType.STEM)));
    public static final RegistryObject<Block> STRIPPED_LEAFY_HYPHAE = createBlock("stripped_leafy_hyphae", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(2.0F).sound(SoundType.STEM)));
    public static final RegistryObject<Block> LILAC_WART_BLOCK = createBlock("lilac_wart_block", () -> new Block(BlockBehaviour.Properties.of(Material.GRASS).strength(1.0F).sound(SoundType.WART_BLOCK)));
    public static final RegistryObject<Block> LEAFY_WART_BLOCK = createBlock("leafy_wart_block", () -> new Block(BlockBehaviour.Properties.of(Material.GRASS).strength(1.0F).sound(SoundType.WART_BLOCK)));
    public static final RegistryObject<Block> LILAC_PLANKS = createBlock("lilac_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LEAFY_PLANKS = createBlock("leafy_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LILAC_STAIRS = createBlock("lilac_stairs", () -> new StairBlock(HoeBlocksRegistry.LILAC_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(LILAC_PLANKS.get())));
    public static final RegistryObject<Block> LEAFY_STAIRS = createBlock("leafy_stairs", () -> new StairBlock(HoeBlocksRegistry.LEAFY_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(LEAFY_PLANKS.get())));
    public static final RegistryObject<Block> LILAC_FENCE = createBlock("lilac_fence", () -> new FenceBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE).strength(3.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LEAFY_FENCE = createBlock("leafy_fence", () -> new FenceBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE).strength(3.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LILAC_FENCE_GATE = createBlock("lilac_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD, LILAC_PLANKS.get().defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LEAFY_FENCE_GATE = createBlock("leafy_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD, LEAFY_PLANKS.get().defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LILAC_SLAB = createBlock("lilac_slab", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(3.5f, 15f)));
    public static final RegistryObject<Block> LEAFY_SLAB = createBlock("leafy_slab", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(3.5f, 15f)));
    public static final RegistryObject<Block> LILAC_PRESSURE_PLATE = createBlock("lilac_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(0.5F)));
    public static final RegistryObject<Block> LEAFY_PRESSURE_PLATE = createBlock("leafy_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(0.5F)));
