...
public class BlockGreenFire extends Block
{
    ...
    {
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !BlocksMod.green_fire.canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
    ...
    public BlockGreenFire(String name)
    {
        super(Material.FIRE);
    ...
    {
    	BlocksMod.green_fire.setFireInfo(Blocks.PLANKS, 5, 20);
    	BlocksMod.green_fire.setFireInfo(Blocks.DOUBLE_WOODEN_SLAB, 5, 20);
    	BlocksMod.green_fire.setFireInfo(Blocks.WOODEN_SLAB, 5, 20);
    	BlocksMod.green_fire.setFireInfo(Blocks.OAK_FENCE_GATE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.SPRUCE_FENCE_GATE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.BIRCH_FENCE_GATE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.JUNGLE_FENCE_GATE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.DARK_OAK_FENCE_GATE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.ACACIA_FENCE_GATE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.OAK_FENCE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.SPRUCE_FENCE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.BIRCH_FENCE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.JUNGLE_FENCE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.DARK_OAK_FENCE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.ACACIA_FENCE, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.OAK_STAIRS, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.BIRCH_STAIRS, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.SPRUCE_STAIRS, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.JUNGLE_STAIRS, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.ACACIA_STAIRS, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.DARK_OAK_STAIRS, 5, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.LOG, 5, 5);
        BlocksMod.green_fire.setFireInfo(Blocks.LOG2, 5, 5);
        BlocksMod.green_fire.setFireInfo(Blocks.LEAVES, 30, 60);
        BlocksMod.green_fire.setFireInfo(Blocks.LEAVES2, 30, 60);
        BlocksMod.green_fire.setFireInfo(Blocks.BOOKSHELF, 30, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.TNT, 15, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.TALLGRASS, 60, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.DOUBLE_PLANT, 60, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.YELLOW_FLOWER, 60, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.RED_FLOWER, 60, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.DEADBUSH, 60, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.WOOL, 30, 60);
        BlocksMod.green_fire.setFireInfo(Blocks.VINE, 15, 100);
        BlocksMod.green_fire.setFireInfo(Blocks.COAL_BLOCK, 5, 5);
        BlocksMod.green_fire.setFireInfo(Blocks.HAY_BLOCK, 60, 20);
        BlocksMod.green_fire.setFireInfo(Blocks.CARPET, 60, 20);
    }
    ...
    public boolean isBlockGreenFireSource(Block block, World world, BlockPos pos, EnumFacing side)
    {
        if(block == BlocksMod.dark_end_stone)
            return true;
        return false;
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (worldIn.getGameRules().getBoolean("doFireTick"))
        {
            ...
            boolean flag = isBlockGreenFireSource(block, worldIn, pos.down(), EnumFacing.UP);
    ...
    public boolean canDie(World worldIn, BlockPos pos)
    {
    ...
    @Deprecated 
    public void catchOnFire(World worldIn, BlockPos pos, int chance, Random random, int age)
    {
    ...
    public void tryCatchFire(World worldIn, BlockPos pos, int chance, Random random, int age, EnumFacing face)
    {
        ...
        if (random.nextInt(chance) < i)
        {
            ...
            {
                this.burnBlockDestroy(worldIn, pos);
            }
    ...
    //Fix no down the fire
    @Override
    public int getFireSpreadSpeed(IBlockAccess world, BlockPos pos, EnumFacing face)
    {
        return BlocksMod.green_fire.getEncouragement(this);
    }
    ...
    {
        if (worldIn.provider.getDimensionType().getId() > 0 || !BlocksMod.portal_dim.trySpawnPortal(worldIn, pos))
        {
            if (!worldIn.getBlockState(pos.down()).isTopSolid() && !this.canNeighborCatchFire(worldIn, pos))
            {
                worldIn.setBlockToAir(pos);
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !BlocksMod.green_fire.canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
            if (BlocksMod.green_fire.canCatchFire(worldIn, pos.west(), EnumFacing.EAST))
            {
                for (int j = 0; j < 2; ++j)
                {
            ...
            if (BlocksMod.green_fire.canCatchFire(worldIn, pos.east(), EnumFacing.WEST))
            {
                for (int k = 0; k < 2; ++k)
                {
            ...
            if (BlocksMod.green_fire.canCatchFire(worldIn, pos.north(), EnumFacing.SOUTH))
            {
                for (int l = 0; l < 2; ++l)
                {
            ...
            if (BlocksMod.green_fire.canCatchFire(worldIn, pos.south(), EnumFacing.NORTH))
            {
            ...
            if (BlocksMod.green_fire.canCatchFire(worldIn, pos.up(), EnumFacing.DOWN))
            {
