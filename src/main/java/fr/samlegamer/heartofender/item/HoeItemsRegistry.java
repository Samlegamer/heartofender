...
public class HoeItemsRegistry
{
	...
	public static final RegistryObject<Item> HEART_BONE_SWORD = REGISTRY_ITEMS.register("heart_bone_sword", () -> new HeartBoneSwordItem(HoeTiers.HEART_BONE, 3, -2.4f, HoeItemUtils.TOOLS));
