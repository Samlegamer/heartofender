...
public class HeartGhast extends FlyingMob implements Enemy
{
	   private static final EntityDataAccessor<Boolean> DATA_IS_CHARGING = SynchedEntityData.defineId(HeartGhast.class, EntityDataSerializers.BOOLEAN);
	   private int explosionPower = 3;

	   @SuppressWarnings({ "rawtypes" })
	   public HeartGhast(EntityType typeentity, Level level)
	   {
	      super(typeentity, level);
	      this.moveControl = new HeartGhast.GhastMoveControl(this);
	      this.xpReward = HoeConfig.HeartGhastExp;
	   }
	   
	    public HeartGhast(PlayMessages.SpawnEntity spawnEntity, Level worldIn)
	    {
	        this(HoeEntityRegistry.HEART_GHAST, worldIn);
	    }
	   protected void registerGoals() {
	      this.goalSelector.addGoal(5, new HeartGhast.RandomFloatAroundGoal(this));
	      this.goalSelector.addGoal(7, new HeartGhast.GhastLookGoal(this));
	      this.goalSelector.addGoal(7, new HeartGhast.GhastShootFireballGoal(this));
	   ...
	   public static AttributeSupplier.Builder createAttributes() {
	      return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, HoeConfig.HeartGhastMaxHealth).add(Attributes.FOLLOW_RANGE, 100.0D);
	   }
	   ...
	   public static boolean checkGhastSpawnRules(EntityType<HeartGhast> p_32735_, LevelAccessor p_32736_, MobSpawnType p_32737_, BlockPos p_32738_, Random p_32739_) {
	   ...
	   static class GhastLookGoal extends Goal {
	      private final HeartGhast ghast;

	      public GhastLookGoal(HeartGhast p_32762_) {
	         this.ghast = p_32762_;
	   ...
	   static class GhastMoveControl extends MoveControl {
	      ...
	      public GhastMoveControl(HeartGhast p_32768_) {
	         super(p_32768_);
	         this.ghast = p_32768_;
	      }
	   ...
	   static class GhastShootFireballGoal extends Goal {
	      ...
	      public GhastShootFireballGoal(HeartGhast p_32776_) {
	         this.ghast = p_32776_;
	      }
	   ...
	   static class RandomFloatAroundGoal extends Goal {
	      ...
	      public RandomFloatAroundGoal(HeartGhast p_32783_) {
	         this.ghast = p_32783_;
