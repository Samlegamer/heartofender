...
import fr.samlegamer.heartofender.world.worldgen.features.*;
...
public class ChunkGeneratorHeartofEnder implements IChunkGenerator
{
    ...
    protected static final IBlockState NETHERRACK = BlocksMod.dark_end_stone.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    protected static final IBlockState LAVA = ModBlocks.GREEN_LAVA_BLOCK.getDefaultState();
    protected static final IBlockState SOUL_SAND = BlocksMod.dead_sand.getDefaultState();
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        if (creatureType == EnumCreatureType.MONSTER)
        {
            ...
            if (this.genNetherBridge.isPositionInStructure(this.world, pos) && this.world.getBlockState(pos.down()).getBlock() == BlocksMod.dark_end_stone_brick)
            {
                return this.genNetherBridge.getSpawnList();
            }
        }
