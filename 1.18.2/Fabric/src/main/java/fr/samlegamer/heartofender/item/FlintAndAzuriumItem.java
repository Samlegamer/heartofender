...
{
	public FlintAndAzuriumItem(Settings settings)
	{
		super(settings);
	}
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (AbstractGreenFireBlock.canPlaceAt(world, blockPos2, context.getPlayerFacing())) {
            ...
            BlockState blockState2 = AbstractGreenFireBlock.getState(world, blockPos2);
