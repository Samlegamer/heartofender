...
public class NyliumBlockHoe extends Block implements BonemealableBlock
{
   ...
   public void performBonemeal(ServerLevel p_55059_, Random p_55060_, BlockPos p_55061_, BlockState p_55062_) {
      ...
      {
    	  HoeFeatures.LILAC_FOREST_VEGETATION_BONEMEAL.value().place(p_55059_, chunkgenerator, p_55060_, blockpos);
      }
      else if (blockstate.is(HoeBlocksRegistry.LEAFY_NYLIUM.get()))
      {
    	  HoeFeatures.LEAFY_FOREST_VEGETATION_BONEMEAL.value().place(p_55059_, chunkgenerator, p_55060_, blockpos);
    	  HoeFeatures.HOE_SPROUTS_BONEMEAL.value().place(p_55059_, chunkgenerator, p_55060_, blockpos);
         if (p_55060_.nextInt(8) == 0) {
        	 HoeFeatures.HOE_TWISTING_VINES_BONEMEAL.value().place(p_55059_, chunkgenerator, p_55060_, blockpos);
         }
      }
