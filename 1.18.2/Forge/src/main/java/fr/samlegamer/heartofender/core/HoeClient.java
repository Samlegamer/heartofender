...
public class HoeClient
{
    ...
    {
        event.registerEntityRenderer(HoeEntityRegistry.ENDER_KID.get(), EnderKidRender::new);
        event.registerEntityRenderer(HoeEntityRegistry.HEART_BLAZE.get(), HeartBlazeRender::new);
        event.registerEntityRenderer(HoeEntityRegistry.HEART_GHAST.get(), HeartGhastRender::new);
