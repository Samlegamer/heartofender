...
public class HoeBlocksRegistry
{
    ...
    public static final RegistryObject<Block> LEAFY_FUNGUS = createBlock("leafy_fungus", () -> new HoeFungusBlock(BlockBehaviour.Properties.of(Material.PLANT).instabreak().noCollission().sound(SoundType.FUNGUS),()->{return HoeFeatures.LEAFY_FUNGUS_PLANTED;}));
    ...
    public static final RegistryObject<Block> LILAC_FUNGUS = createBlock("lilac_fungus", () -> new HoeFungusBlock(BlockBehaviour.Properties.of(Material.PLANT).instabreak().noCollission().sound(SoundType.FUNGUS),()->{return HoeFeatures.LILAC_FUNGUS_PLANTED;}));
