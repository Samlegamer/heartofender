...
public class HoeServerConfig
{
	...
	public HoeServerConfig(final ForgeConfigSpec.Builder build)
	{
		...
		this.HeartEnderShip = StructureConfig.builder(build, "Heart of Ender Ship").pushPlacement().probability(75).popPlacement().pushConfigured().dimensions(HoeDimensionRegistry.HEART_OF_ENDER).popConfigured().build();


				
			//	structureBuilder(build, "Heart of Ender Ship", 25, 6, 2, true, "heartofender:heartofender_wastes", HoeDimensionRegistry.HEART_OF_ENDER);
		this.HeartofEnderFortress = StructureConfig.builder(build, "Heart of Ender Fortress").placement(50, 6, 15).pushConfigured().dimensions(HoeDimensionRegistry.HEART_OF_ENDER).popConfigured().build();

				//structureBuilder(build, "Heart of Ender Fortress", 50, 6, 15, true, "heartofender:heartofender_wastes", HoeDimensionRegistry.HEART_OF_ENDER);
