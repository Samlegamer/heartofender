...
public class GreenWallTorchBlock  extends GreenTorchBlock
{
	   ...
	   public GreenWallTorchBlock(AbstractBlock.Properties p_i241193_1_) {
	      super(p_i241193_1_);
	   ...
	   public void animateTick(BlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
	      ...
	      p_180655_2_.addParticle(ModParticles.GREEN_FLAME.get(), d0 + 0.27D * (double)direction1.getStepX(), d1 + 0.22D, d2 + 0.27D * (double)direction1.getStepZ(), 0.0D, 0.0D, 0.0D);
	   }
