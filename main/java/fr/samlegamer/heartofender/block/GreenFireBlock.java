...
public class GreenFireBlock extends AbstractGreenFireBlock
{
	   ...
	   public GreenFireBlock(AbstractBlock.Properties p_i48397_1_) {
	      ...
	      this.shapesCache = ImmutableMap.copyOf(this.stateDefinition.getPossibleStates().stream().filter((p_242674_0_) -> {
		   ...
		   public static BlockState getState(IBlockReader p_235326_0_, BlockPos p_235326_1_) {
		      ...
		      return canSurviveOnBlock(blockstate.getBlock()) ? ModBlocks.GREEN_FIRE.get().defaultBlockState() : ((GreenFireBlock)ModBlocks.GREEN_FIRE.get()).getStateForPlacement(p_235326_0_, p_235326_1_);
		   }
		   
		   
		   
		   public static boolean canSurviveOnBlock(Block blockIn)
		   {
			   return blockIn.is(ModBlocks.DARK_END_STONE.get());
		   }
	   
	   public boolean isBlockFireSource(Block block, World world, BlockPos pos)
	    {
		   return block.is(ModBlocks.DARK_END_STONE.get());
	    }
	   ...
	   private BlockState getStateWithAge(IWorld p_235494_1_, BlockPos p_235494_2_, int p_235494_3_) {
	      ...
	      return blockstate.is(ModBlocks.GREEN_FIRE.get()) ? blockstate.setValue(AGE, Integer.valueOf(p_235494_3_)) : blockstate;
	   }
	   ...
	   {
	      return p_196446_1_.is(ModBlocks.DARK_END_STONE.get());
	   }
	   ...
	   public static void bootStrap() {
		   GreenFireBlock fireblock = (GreenFireBlock)ModBlocks.GREEN_FIRE.get();
	   ...
	   public static boolean canBePlacedAt(World p_241465_0_, BlockPos p_241465_1_, Direction p_241465_2_)
		{
		   ...
		   private static boolean isPortal(World p_241466_0_, BlockPos p_241466_1_, Direction p_241466_2_) {
			      if (!inPortalDimension(p_241466_0_)) {
			         ...
			         for(Direction direction : Direction.values()) {
			            if (p_241466_0_.getBlockState(blockpos$mutable.set(p_241466_1_).move(direction)).is(ModBlocks.HEART_ENDER_PORTAL_BLOCK.get())) {
			               flag = true;
			               break;
			            }
			         }
