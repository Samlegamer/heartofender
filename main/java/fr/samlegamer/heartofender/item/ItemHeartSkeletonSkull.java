...
public class ItemHeartSkeletonSkull extends Item
{
    private static final String[] SKULL_TYPES = new String[] {"heart_skeleton"};

    public ItemHeartSkeletonSkull(String name)
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (player.canPlayerEdit(pos, facing, itemstack) && BlocksMod.heart_skeleton_skull.canPlaceBlockAt(worldIn, pos))
            {
                if (worldIn.isRemote)
                {
                ...
                {
                    worldIn.setBlockState(pos, BlocksMod.heart_skeleton_skull.getDefaultState().withProperty(BlockHeartSkeletonSkull.FACING, facing), 11);
                    int i = 0;
                    ...
                    if (tileentity instanceof TileEntitySkull)
                    {
                        ...
                        BlocksMod.heart_skeleton_skull.checkWitherSpawn(worldIn, pos, tileentityskull);
                    }
