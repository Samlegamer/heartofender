...
public class HoeItemsRegistry
{
	...
	public static final RegistryObject<Item> MILATHIUM_INGOT = REGISTRY_ITEMS.register("milathium_ingot", () -> new Item(HoeItemUtils.BASE));
	...
	public static final RegistryObject<Item> HEART_BONE = REGISTRY_ITEMS.register("heart_bone", () -> new Item(HoeItemUtils.BASE));
	//public static final RegistryObject<Item> GREEN_FIRE_CHARGE = REGISTRY_ITEMS.register("green_fire_charge", () -> new GreenFireChargeItem(new Item.Properties().rarity(Rarity.RARE).stacksTo(16).tab(HeartofEnder.CREATIVE_TAB_ITEMS)));
	...
	public static final RegistryObject<Item> MILATHIUM_HELMET = REGISTRY_ITEMS.register("milathium_helmet", () -> new ArmorItem(HoeArmors.MILATHIUM_ARMOR, EquipmentSlot.HEAD, HoeItemUtils.ARMORS.fireResistant()));
    public static final RegistryObject<Item> MILATHIUM_CHESTPLATE = REGISTRY_ITEMS.register("milathium_chestplate", () -> new ArmorItem(HoeArmors.MILATHIUM_ARMOR, EquipmentSlot.CHEST, HoeItemUtils.ARMORS.fireResistant()));
    public static final RegistryObject<Item> MILATHIUM_LEGGINGS = REGISTRY_ITEMS.register("milathium_leggings", () -> new ArmorItem(HoeArmors.MILATHIUM_ARMOR, EquipmentSlot.LEGS, HoeItemUtils.ARMORS.fireResistant()));
    public static final RegistryObject<Item> MILATHIUM_BOOTS = REGISTRY_ITEMS.register("milathium_boots", () -> new ArmorItem(HoeArmors.MILATHIUM_ARMOR, EquipmentSlot.FEET, HoeItemUtils.ARMORS.fireResistant()));
