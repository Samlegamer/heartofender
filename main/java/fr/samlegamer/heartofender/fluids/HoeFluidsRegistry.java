...
public class HoeFluidsRegistry
{
	...
	public static final RegistryObject<LiquidBlock> GREEN_LAVA_BLOCK = HoeBlocksRegistry.REGISTRY_BLOCKS.register("green_lava_block", () -> new LiquidBlock(() -> HoeFluidsRegistry.GREEN_LAVA.get(), BlockBehaviour.Properties.of(Material.LAVA).lightLevel((p_235468_0_) -> {return 30;}).randomTicks().noCollission().strength(100.0F).noDrops()));
