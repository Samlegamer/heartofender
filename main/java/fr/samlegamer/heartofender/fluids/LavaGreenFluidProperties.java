...
public class LavaGreenFluidProperties extends ForgeFlowingFluid
{
	...
	public LavaGreenFluidProperties(Properties properties)
	{
		...
		if(entity instanceof ItemEntity)
	        ...
	        //super.isEntityInside(world, pos, state, entity);
	}
	   ...
	   public void animateTick(World p_204522_1_, BlockPos p_204522_2_, FluidState p_204522_3_, Random p_204522_4_) {
	      ...
	      if (p_204522_1_.getBlockState(blockpos).isAir() && !p_204522_1_.getBlockState(blockpos).isSolidRender(p_204522_1_, blockpos)) {
	         if (p_204522_4_.nextInt(100) == 0) {
	            ...
	            p_204522_1_.addParticle(ModParticles.GREEN_LAVA.get(), d0, d1, d2, 0.0D, 0.0D, 0.0D);
	...
	public void randomTick(World p_207186_1_, BlockPos p_207186_2_, FluidState p_207186_3_, Random p_207186_4_) {
	         ...
	         if (i > 0) {
	            ...
	            for(int j = 0; j < i; ++j) {
	               ...
	               if (blockstate.isAir()) {
	                  if (this.hasFlammableNeighbours(p_207186_1_, blockpos)) {
	                     p_207186_1_.setBlockAndUpdate(blockpos, net.minecraftforge.event.ForgeEventFactory.fireFluidPlaceBlockEvent(p_207186_1_, blockpos, p_207186_2_, ModBlocks.GREEN_FIRE.get().defaultBlockState()));
	                     return;
	                  }
	            ...
	            for(int k = 0; k < 3; ++k) {
	               ...
	               if (p_207186_1_.isEmptyBlock(blockpos1.above()) && this.isFlammable(p_207186_1_, blockpos1)) {
	                  p_207186_1_.setBlockAndUpdate(blockpos1.above(), net.minecraftforge.event.ForgeEventFactory.fireFluidPlaceBlockEvent(p_207186_1_, blockpos1.above(), p_207186_2_, ModBlocks.GREEN_FIRE.get().defaultBlockState()));
	               }
	            }
	         }
	   ...
	   public BlockState createLegacyBlock(FluidState p_204527_1_) {
	      return ModFluids.GREEN_LAVA_BLOCK.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
	   }

	   public boolean isSame(Fluid p_207187_1_) {
	      return p_207187_1_ == ModFluids.GREEN_LAVA.get() || p_207187_1_ == ModFluids.GREEN_LAVA_FLOW.get();
	   }
	      ...
	      if (p_205574_4_ == Direction.DOWN) {
	         ...
	         if (this.is(FluidTags.LAVA) && fluidstate.is(FluidTags.WATER)) {
	            if (p_205574_3_.getBlock() instanceof FlowingFluidBlock) {
	               p_205574_1_.setBlock(p_205574_2_, net.minecraftforge.event.ForgeEventFactory.fireFluidPlaceBlockEvent(p_205574_1_, p_205574_2_, p_205574_2_, ModBlocks.DARK_END_STONE.get().defaultBlockState()), 3);
	            }
