...
public class GenWorldHeartFortress extends WorldGenerator
{
    public EnumFacing facing;
    private static final ResourceLocation STRUCTURE = new ResourceLocation(References.MODID, "heart_fortress1");

    public GenWorldHeartFortress(EnumFacing facing) {
        super(false);
        this.facing = facing;
    }
