...
public class ChunkGeneratorHeartofEnder implements IChunkGenerator
{
    ...
    */
    ...
    {
        return "Heart Ender Fortress".equals(structureName) && this.genHeartEnderFortress != null ? this.genHeartEnderFortress.getNearestStructurePos(worldIn, position, findUnexplored) : null;
    }

    public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos)
    {
        return "Heart Ender Fortress".equals(structureName) && this.genHeartEnderFortress != null ? this.genHeartEnderFortress.isInsideStructure(pos) : false;
    }
