...
public class ChunkGeneratorHeartofEnder implements IChunkGenerator
{
    ...
    private final WorldGenerator quartzGen = new WorldGenMinable(BlocksMod.milathium_ore.getDefaultState(), 5, BlockMatcher.forBlock(BlocksMod.dark_end_stone));
    private final WorldGenerator magmaGen = new WorldGenMinable(BlocksMod.blue_magma_block.getDefaultState(), 33, BlockMatcher.forBlock(BlocksMod.dark_end_stone));
