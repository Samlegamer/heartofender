...
import fr.samlegamer.heartofender.world.worldgen.ChunkGeneratorHeartofEnder;
...
public class MapGeneratorHeartFortress extends MapGenStructure
{
    ...
    public MapGeneratorHeartFortress()
    {
        ...
        this.spawnList.add(new Biome.SpawnListEntry(EntityWitherSkeleton.class, 15, 5, 5));
