package fr.samlegamer.heartofender.world.dim;
...
public class TeleporterHeartofEnder implements ITeleporter
{
	   ...
	   public TeleporterHeartofEnder(ServerWorld p_i1963_1_) {
	   ...
	   public Optional<TeleportationRepositioner.Result> findPortalAround(BlockPos p_242957_1_, boolean p_242957_2_) {
	      ...
	      Optional<PointOfInterest> optional = pointofinterestmanager.getInSquare((p_242952_0_) -> {
	         return p_242952_0_ == ModPOI.HEART_OF_ENDER_PORTAL.get();
	   ...
	   Direction.Axis p_242956_2_;

	   public Optional<TeleportationRepositioner.Result> createPortal(BlockPos p_242956_1_) {
		         ...
		         for(int l1 = -1; l1 < 2; ++l1) {
		            for(int k2 = 0; k2 < 2; ++k2) {
		               for(int i3 = -1; i3 < 3; ++i3) {
		                  BlockState blockstate1 = i3 < 0 ? ModBlocks.HEART_ENDER_PORTAL_BLOCK.get().defaultBlockState() : Blocks.AIR.defaultBlockState();
		      ...
		      for(int k1 = -1; k1 < 3; ++k1) {
		         for(int i2 = -1; i2 < 4; ++i2) {
		            if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
		               ...
		               this.level.setBlock(blockpos$mutable, ModBlocks.HEART_ENDER_PORTAL_BLOCK.get().defaultBlockState(), 3);
		            }
		         }
		      }

		      BlockState blockstate = ModBlocks.HEART_OF_ENDER_PORTAL.get().defaultBlockState().setValue(PortalDimBlock.AXIS, p_242956_2_);
