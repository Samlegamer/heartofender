...
public class HeartofEnderSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig>
{
	   @SuppressWarnings("unused")
	private static final BlockState AIR = Blocks.CAVE_AIR.defaultBlockState();
	   private static final BlockState GRAVEL = ModBlocks.BLUE_MAGMA_BLOCK.get().defaultBlockState();
	   private static final BlockState SOUL_SAND = ModBlocks.DEAD_SAND.get().defaultBlockState();
	   protected long seed;
	   protected OctavesNoiseGenerator decorationNoise;

	   public HeartofEnderSurfaceBuilder(Codec<SurfaceBuilderConfig> p_i232132_1_) {
	      super(p_i232132_1_);
	   }
