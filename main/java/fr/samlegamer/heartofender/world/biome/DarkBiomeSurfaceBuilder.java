...
public class DarkBiomeSurfaceBuilder
{
    ...
    public static final ConfiguredSurfaceBuilder<SurfaceBuilderConfig> DARK_BIOME_BUILDER = register("dark", SurfaceBuilder.DEFAULT.configured(DARK_BIOME_SURFACE));
