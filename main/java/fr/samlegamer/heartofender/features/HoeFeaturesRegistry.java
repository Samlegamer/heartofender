...
public class HoeFeaturesRegistry
{
	...
	public static final RegistryObject<Feature<NoneFeatureConfiguration>> PURPLE_GLOWSTONE_BLOB = REGISTRY_FEATURES.register("purple_glowstone_blob", () -> new PurpleGlowstoneBlobFeature(NoneFeatureConfiguration.CODEC));
