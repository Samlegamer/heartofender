...
public class ModEntities
{
	...
	public static final EntityType<HeartBlazeEntity> HEART_BLAZE = registerEntity(EntityType.Builder.of(HeartBlazeEntity::new, EntityClassification.MONSTER).sized(1.0f, 2.0f).setCustomClientFactory(HeartBlazeEntity::new).canSpawnFarFromPlayer(), "heart_blaze");
	@SuppressWarnings("unchecked")
	...
	@SuppressWarnings("unchecked")
	public static final EntityType<HeartGhastEntity> HEART_GHAST = registerEntity(EntityType.Builder.of(HeartGhastEntity::new, EntityClassification.MONSTER).sized(4.0F, 4.0F).setCustomClientFactory(HeartGhastEntity::new).canSpawnFarFromPlayer(), "heart_ghast");
	@SuppressWarnings("unchecked")
