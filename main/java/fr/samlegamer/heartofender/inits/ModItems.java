...
public class ModItems
{
	...
	public static final RegistryObject<FlintandAzuriumItem> FLINT_AND_AZURIUM = ITEMS_REGISTRY.register("flint_and_azurium", () -> new FlintandAzuriumItem(new Item.Properties().stacksTo(1).tab(HeartofEnder.CREATIVE_TAB_ITEMS)));
