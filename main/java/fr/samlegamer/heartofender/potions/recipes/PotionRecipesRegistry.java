...
public class PotionRecipesRegistry
{
	...
	public static void registerRecipes()
	{
		...
		heal3.putString("Potion", "heartofender:heal_boost_iii");
		ItemStack potionheal3 = new ItemStack(Items.POTION);
		potionheal3.setTag(heal3.copy());

		BrewingRecipeRegistry.addRecipe(Ingredient.of(potion1), Ingredient.of(ModItems.PURPLE_GLOWSTONE_DUST.get()), potionheal3);
		...
		BrewingRecipeRegistry.addRecipe(Ingredient.of(potion2), Ingredient.of(ModItems.PURPLE_GLOWSTONE_DUST.get()), potionswiftness3);
		...
		BrewingRecipeRegistry.addRecipe(Ingredient.of(potion3), Ingredient.of(ModItems.PURPLE_GLOWSTONE_DUST.get()), potionregeneration3);
		...
		BrewingRecipeRegistry.addRecipe(Ingredient.of(potion4), Ingredient.of(ModItems.PURPLE_GLOWSTONE_DUST.get()), potionstrength3);
