...
public class HeartBlazeEntity extends MonsterEntity
{
	   private float allowedHeightOffset = 0.5F;
	   private int nextHeightOffsetChangeTick;
	   private static final DataParameter<Byte> DATA_FLAGS_ID = EntityDataManager.defineId(HeartBlazeEntity.class, DataSerializers.BYTE);

	   @SuppressWarnings({ "rawtypes" })
	public HeartBlazeEntity(EntityType typeentity, World world) {
	    ...
	    public HeartBlazeEntity(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn)
	    {
	        this(ModEntities.HEART_BLAZE, worldIn);
	    }

	   protected void registerGoals() {
	      this.goalSelector.addGoal(4, new HeartBlazeEntity.FireballAttackGoal(this));
	   ...
	   static class FireballAttackGoal extends Goal {
	      private final HeartBlazeEntity blaze;
	      private int attackStep;
	      private int attackTime;
	      private int lastSeen;

	      public FireballAttackGoal(HeartBlazeEntity p_i45846_1_) {
