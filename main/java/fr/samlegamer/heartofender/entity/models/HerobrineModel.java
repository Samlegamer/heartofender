...
@OnlyIn(Dist.CLIENT)
public class HerobrineModel <T extends HerobrineEntity> extends BipedModel<T>
{
	   public HerobrineModel(float p_i1168_1_, boolean p_i1168_2_)
	   {
		   this(p_i1168_1_, 0.0F, 64, p_i1168_2_ ? 32 : 64);
	   }

	   protected HerobrineModel(float p_i48914_1_, float p_i48914_2_, int p_i48914_3_, int p_i48914_4_)
	   {
