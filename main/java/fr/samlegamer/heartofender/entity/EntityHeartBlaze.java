...
public class EntityHeartBlaze extends EntityMob
{
    private float heightOffset = 0.5F;

	public static final ResourceLocation LOOT = new ResourceLocation(References.MODID, "heartblaze/heartblaze");
    private int heightOffsetUpdateTime;
    private static final DataParameter<Byte> ON_FIRE = EntityDataManager.<Byte>createKey(EntityHeartBlaze.class, DataSerializers.BYTE);

    public EntityHeartBlaze(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityHeartBlaze.class);
    }

    protected void initEntityAI()
    {
        this.tasks.addTask(4, new EntityHeartBlaze.AIFireballAttack(this));
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.24000000917232513D);
    ...
    static class AIFireballAttack extends EntityAIBase
        {
            private final EntityHeartBlaze blaze;
            private int attackStep;
            private int attackTime;

            public AIFireballAttack(EntityHeartBlaze blazeIn)
            {
                this.blaze = blazeIn;
                this.setMutexBits(3);
            }
