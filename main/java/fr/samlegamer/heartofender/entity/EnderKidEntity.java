...
public class EnderKidEntity extends EndermanEntity implements IAngerable
{
	   ...
	   private static final DataParameter<Optional<BlockState>> DATA_CARRY_STATE = EntityDataManager.defineId(EnderKidEntity.class, DataSerializers.BLOCK_STATE);
	   private static final DataParameter<Boolean> DATA_CREEPY = EntityDataManager.defineId(EnderKidEntity.class, DataSerializers.BOOLEAN);
	   private static final DataParameter<Boolean> DATA_STARED_AT = EntityDataManager.defineId(EnderKidEntity.class, DataSerializers.BOOLEAN);
	   ...
	   public EnderKidEntity(EntityType typeentity, World world) {
	      super(typeentity, world);
	      this.maxUpStep = 1.0F;
	      this.xpReward = HoeConfig.EnderKidExp;
	      this.setPathfindingMalus(PathNodeType.WATER, -1.0F);
	   }

	    public EnderKidEntity(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn)
	    {
	        this(ModEntities.ENDER_KID, worldIn);
	    }
	   ...
	   protected void registerGoals() {
	      ...
	      this.goalSelector.addGoal(1, new EnderKidEntity.StareGoal(this));
	      this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.0D, false));
	      this.goalSelector.addGoal(7, new WaterAvoidingRandomWalkingGoal(this, 1.0D, 0.0F));
	      this.goalSelector.addGoal(8, new LookAtGoal(this, PlayerEntity.class, 8.0F));
	      this.goalSelector.addGoal(8, new LookRandomlyGoal(this));
	      this.goalSelector.addGoal(10, new EnderKidEntity.PlaceBlockGoal(this));
	      this.goalSelector.addGoal(11, new EnderKidEntity.TakeBlockGoal(this));
	      this.targetSelector.addGoal(1, new EnderKidEntity.FindPlayerGoal(this, this::isAngryAt));
	   ...
	   public static AttributeModifierMap.MutableAttribute createAttributes() {
	      return MonsterEntity.createMonsterAttributes()
	    		  .add(Attributes.MAX_HEALTH, HoeConfig.EnderKidMaxHealth)
	    		  .add(Attributes.MOVEMENT_SPEED, (double)HoeConfig.EnderKidMovementSpeed)
	    		  .add(Attributes.ATTACK_DAMAGE, HoeConfig.EnderKidAttackDamage)
	...
	private boolean teleportTowards(Entity p_70816_1_) {
	   ...
	   static class FindPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
	      ...
	      public FindPlayerGoal(EnderKidEntity p_i241912_1_, @Nullable Predicate<LivingEntity> p_i241912_2_) {
	   ...
	   static class PlaceBlockGoal extends Goal {
	      ...
	      public PlaceBlockGoal(EnderKidEntity p_i45843_1_) {
	   ...
	   static class StareGoal extends Goal {
	      ...
	      public StareGoal(EnderKidEntity p_i50520_1_) {
	   ...
	   static class TakeBlockGoal extends Goal {
	      ...
	      public TakeBlockGoal(EnderKidEntity p_i45841_1_) {
